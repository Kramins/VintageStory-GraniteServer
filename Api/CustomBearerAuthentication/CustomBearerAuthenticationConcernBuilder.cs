...
public class CustomBearerAuthenticationConcernBuilder : IConcernBuilder
{
    ...
    /// issued a token.
    /// </remarks>
    public CustomBearerAuthenticationConcernBuilder Issuer(string issuer)
    {
    ...
    public CustomBearerAuthenticationConcernBuilder Audience(string audience)
    {
    ...
    /// </remarks>
    public CustomBearerAuthenticationConcernBuilder Validation(
        Func<JwtSecurityToken, Task> validator
    )
    {
    ...
    /// </remarks>
    public CustomBearerAuthenticationConcernBuilder UserMapping(
        Func<IRequest, JwtSecurityToken, ValueTask<IUser?>> userMapping
    )
    {
    ...
    /// </summary>
    public CustomBearerAuthenticationConcernBuilder AllowExpired()
    {
        _options.Lifetime = false;
        return this;
    }

    public CustomBearerAuthenticationConcernBuilder KeyResolver(
        Func<
            JwtSecurityToken,
            ValueTask<ICollection<Microsoft.IdentityModel.Tokens.SecurityKey>>
        > keyResolver
    )
    {
        _options.KeyResolver = keyResolver;
        return this;
    }

    public IConcern Build(IHandler content) =>
        new CustomBearerAuthenticationConcern(content, _options);
}
