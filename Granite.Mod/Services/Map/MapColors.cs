...
{
    /// <summary>
    /// Gets the default map color code for a block material type.
    /// </summary>
    /// <param name="material">The block material</param>
    ...
    public static string GetDefaultMapColorCode(EnumBlockMaterial material)
    {
        return material switch
        {
            ...
            EnumBlockMaterial.Meta => "land",
            EnumBlockMaterial.Brick => "settlement",
            EnumBlockMaterial.Ceramic => "settlement",
            EnumBlockMaterial.Glass => "settlement",
            EnumBlockMaterial.Cloth => "settlement",
            EnumBlockMaterial.Mantle => "land",
            _ => "land"
        };
    }
    ...
    /// <summary>
    /// Gets the color code for a specific color code string.
    /// </summary>
